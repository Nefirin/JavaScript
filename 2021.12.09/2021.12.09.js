 ...
 */
function filterByName(phoneBook, n) {
...
add(myPhoneBook, "Oliver Kovacs", 123456789)
add(myPhoneBook, "Oliver Kovacs", 987654321)

filterBy (myPhoneBook, function (bejegyzes) { bejegyzes.name === "Oliver Kovacs"});
filterBy (myPhoneBook, function (bejegyzes) { bejegyzes.mobile === 987654321})